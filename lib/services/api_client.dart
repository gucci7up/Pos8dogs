...
/// Thin wrapper around the MBSport DS8 backend REST API.
class ApiClient {
  /// Backend de DS8. Se puede apuntar a otro al compilar:
  ///   flutter build windows --dart-define=API_BASE_URL=http://localhost:3000
